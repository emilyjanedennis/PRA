...
if __name__ == "__main__":
    ...
    brains = ["a235","c514","e106","f119","k304","k327","c223","h170","k303","k320","k333"]
    ...
    memmappth = os.path.join(output_fld, "k320_memmap_25um.npy")
    #Location to save out our atlas (median image)
    final_output_path = os.path.join(output_fld, "20201007_median_male_k320seed_25um.tif")
