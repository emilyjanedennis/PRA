...
if __name__ == "__main__":
    ...
    src = "/jukebox/scratch/ejdennis/lightsheet"

    #["k327","k321","k323","k320"]
    brains = ["k321","k323","k327","k320"]
    #inputs = [os.path.join(src, xx+"/downsized_for_atlas.tif") for xx in brains]

    output_fld = "/jukebox/scratch/ejdennis/lightsheet/male_atlas/out_new_2021_03"
    if not os.path.exists(output_fld): os.mkdir(output_fld)

    data_fld = "/jukebox/scratch/ejdennis/lightsheet/male_atlas/out_new_2021_03"
    ...
    final_output_path = os.path.join(output_fld, "median_male_k320seed_image_2021_03.tif")
