...
if __name__ == "__main__":
    ...
    output_fld = "/home/emilyjanedennis/Desktop/PRA_out"
    ...
    seed = os.path.join(data_fld, "PRAm_seed3.tif")
    ...
    final_output_path = os.path.join(output_fld, "PRAm_seed4.tif")
    ...
    if len(sys.argv) > 0:
        ...
        print("job id is {}".format(jobid))
    else:
        print('error no arguments given')
    #for jobid in np.arange(0,len(brains)):
    brain = brains[jobid]
